export abstract class AxisMind
{
    ...
    core: RoomObject | undefined; // host object to determine room/position data of mind instance
    memory: any;

    constructor(type: string, host: {name: string, core: RoomObject | undefined})
    {
